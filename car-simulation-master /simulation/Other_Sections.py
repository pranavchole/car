...
class InfoBar(arcade.Section):
    def __init__(self, left: int, bottom: int, width: int, height: int, **kwargs):
        ...
        self.steering_wheel = arcade.Sprite('/Users/pranavchole/Downloads/car-simulation-master /resources/steering_wheel.png',0.1,center_x= 50,center_y=self.window.height - 50)
